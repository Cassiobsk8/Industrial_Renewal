...
{
    public ItemCartBase(String name, CreativeTabs tab)
    {
        super(name, tab);
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (!worldIn.isRemote)
            {
                ...
                EntityMinecart entityminecart = getEntity(worldIn, (double) pos.getX() + 0.5D, (double) pos.getY() + 0.0625D + d0, (double) pos.getZ() + 0.5D);
    ...
    public abstract EntityMinecart getEntity(World world, double x, double y, double z);
}
