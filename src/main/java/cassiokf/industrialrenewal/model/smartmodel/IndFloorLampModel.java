...
public class IndFloorLampModel implements IModel
{
    public static final ModelResourceLocation MODEL_UP = new ModelResourceLocation("industrialrenewal:indfloor/con_up_lamp");
