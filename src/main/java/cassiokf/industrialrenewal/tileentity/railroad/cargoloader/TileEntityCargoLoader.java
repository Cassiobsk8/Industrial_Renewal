...
public class TileEntityCargoLoader extends TileEntityLockableLoot implements IHopper, ITickable {
    ...
    public static void registerFixesHopper(DataFixer fixer) {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityCargoLoader.class, "Items"));
    }
    ...
    private void letCartPass() {
        ...
        if (oldState.getBlock() instanceof BlockLoaderRail) {
            this.world.setBlockState(this.pos.down(), oldState.withProperty(BlockLoaderRail.PASS, true));
        }
    }
            ...
            if (flag)
            {
                if (flag1 && destination instanceof TileEntityCargoLoader)
                {
                    ...
                    if (!tileentityhopper1.mayTransfer())
                    {
                        ...
                        if (source != null && source instanceof TileEntityCargoLoader)
                        {
