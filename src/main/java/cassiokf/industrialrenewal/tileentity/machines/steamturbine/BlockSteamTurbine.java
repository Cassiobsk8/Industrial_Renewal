...
public class BlockSteamTurbine extends BlockTileEntity<TileEntitySteamTurbine>
{
    ...
    {
        TileEntitySteamTurbine te = (TileEntitySteamTurbine) worldIn.getTileEntity(pos);
        if (te != null)
        {
            te.breakMultiBlocks();
        }
