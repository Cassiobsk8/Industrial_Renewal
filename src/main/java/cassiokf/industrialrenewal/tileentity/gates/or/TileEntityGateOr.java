...
public class TileEntityGateOr extends TileEntity {
    ...
    public void exchange10(World world, BlockPos pos, IBlockState state) {
        world.setBlockState(pos, state.withProperty(ACTIVE10, true).withProperty(ACTIVE, true).withProperty(ACTIVE01, false));
    }
    public void exchange01(World world, BlockPos pos, IBlockState state) {
        world.setBlockState(pos, state.withProperty(ACTIVE01, true).withProperty(ACTIVE, true).withProperty(ACTIVE10, false));
    }
