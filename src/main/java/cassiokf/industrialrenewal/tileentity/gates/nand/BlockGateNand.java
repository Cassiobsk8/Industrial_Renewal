...
public class BlockGateNand extends BlockTileEntity<TileEntityGateNand> {
    ...
    public void change(World worldIn, BlockPos pos, IBlockState state){
        ...
        final TileEntityGateNand tileEntity = getTileEntity(worldIn, pos);
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
        final TileEntityGateNand tileEntity = getTileEntity(world, pos);
    ...
    @Override
    public Class<TileEntityGateNand> getTileEntityClass() {
        return TileEntityGateNand.class;
	}

    @Nullable
    @Override
    public TileEntityGateNand createTileEntity(World world, IBlockState state) {
        return new TileEntityGateNand();
    }
