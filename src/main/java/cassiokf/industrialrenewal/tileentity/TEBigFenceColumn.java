...
import static cassiokf.industrialrenewal.init.TileRegistration.BIGFENCE_COLUMN;

public class TEBigFenceColumn extends TEBigFenceBase
{

    public TEBigFenceColumn()
    {
        super(BIGFENCE_COLUMN.get());
    }
