...
public class ItemsRegistration
{
    ...
    //public static final RegistryObject<Item> DISC1 = ITEMS.register("record_royal_entrance", () -> new ItemDiscBase(new Item.Properties().group(References.GROUP_INDR), SoundsRegistration.DISC_1.get()));
    ...
    public static final RegistryObject<Item> DRILLSTEEL = ITEMS.register("drill_steel", () -> new ItemDrill(new Item.Properties().group(References.GROUP_INDR)));
    public static final RegistryObject<Item> DRILLDIAMOND = ITEMS.register("drill_diamond", () -> new ItemDrill(new Item.Properties().group(References.GROUP_INDR)));
