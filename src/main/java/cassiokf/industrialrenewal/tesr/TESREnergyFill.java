...
public class TESREnergyFill extends TileEntitySpecialRenderer<TileEntityEnergyLevel>
{
    ...
    public void render(TileEntityEnergyLevel te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        RenderText(te, xPos, y + 0.18, zPos);
        RenderPointer(te, xPos, y + 0.27, zPos);
    }
     ...
     * x = side / y = up / z = front
     */
    private void RenderText(TileEntityEnergyLevel te, double x, double y, double z)
    {
    ...
    private void RenderPointer(TileEntityEnergyLevel te, double x, double y, double z)
    {
        ...
        GlStateManager.scale(1.2F, angle * 1.2F, 0.05F);
