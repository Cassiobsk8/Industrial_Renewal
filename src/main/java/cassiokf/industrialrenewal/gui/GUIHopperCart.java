...
public class GUIHopperCart extends GuiContainer
{
    ...
    private EntityHopperCart entity;
    private IInventory playerInv;


    public GUIHopperCart(IInventory playerInv, EntityHopperCart entity)
    {
        super(new ContainerHopperCart(playerInv, entity));
    ...
    {
        String name = I18n.format(ModItems.hopperCart.getTranslationKey() + ".name");
