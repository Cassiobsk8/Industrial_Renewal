...
public class RenderFlatCart<T extends EntityFlatCart> extends Render<EntityFlatCart>
{

    public static final ResourceLocation TEXTURES = new ResourceLocation(References.MODID + ":textures/entities/base_cart.png");

    protected ModelCartFlat modelMinecart = new ModelCartFlat();
    ...
    public void doRender(EntityFlatCart entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
