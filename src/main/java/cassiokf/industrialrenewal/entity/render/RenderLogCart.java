...
public class RenderLogCart<T extends EntityLogCart> extends Render<EntityLogCart> {
    ...
    public void doRender(EntityLogCart entity, double x, double y, double z, float entityYaw, float partialTicks) {
