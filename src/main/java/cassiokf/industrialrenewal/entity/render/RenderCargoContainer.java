...
@OnlyIn(Dist.CLIENT)
public class RenderCargoContainer extends EntityRenderer<EntityCargoContainer>
{
    public static final ResourceLocation TEXTURES = new ResourceLocation(References.MODID, "textures/entities/cargocontainer.png");

    protected final EntityModel<EntityCargoContainer> modelMinecart = new ModelCargoContainer();
    ...
    public void render(EntityCargoContainer entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
    ...
    @Override
    public ResourceLocation getEntityTexture(EntityCargoContainer entity)
    {
        return TEXTURES;
    }
}
