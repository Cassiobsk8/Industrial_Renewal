...
import cassiokf.industrialrenewal.entity.model.ModelCargoContainer;
...
public class RenderCargoContainer<T extends EntityCargoContainer> extends Render<EntityCargoContainer> {
    ...
    public void doRender(EntityCargoContainer entity, double x, double y, double z, float entityYaw, float partialTicks) {
