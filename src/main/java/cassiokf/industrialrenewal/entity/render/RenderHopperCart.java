...
public class RenderHopperCart<T extends EntityHopperCart> extends Render<EntityHopperCart>
{
    ...
    public void doRender(EntityHopperCart entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
