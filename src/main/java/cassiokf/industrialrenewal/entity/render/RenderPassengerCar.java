...
public class RenderPassengerCar<T extends EntityPassengerCar> extends Render<EntityPassengerCar> {
    ...
    @Override
    public void doRender(final EntityPassengerCar entity, double x, double y, double z, float entityYaw, final float partialTicks) {
