...
public class BlockWindTurbineSmall extends BlockHorizontalFacing
{
    ...
    public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
    {
        tooltip.add(new StringTextComponent(I18n.format("info.industrialrenewal.produces")
                + ": "
                + (IRConfig.Main.maxEnergySWindTurbine.get())
                + " FE/t"));
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context)
    {
        ...
        return getDefaultState().with(FACING, placer.isSneaking() ? placer.getHorizontalFacing().getOpposite() : placer.getHorizontalFacing());
    }
