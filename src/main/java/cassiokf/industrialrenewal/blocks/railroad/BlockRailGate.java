...
public class BlockRailGate extends BlockNormalRailBase
{
    ...
    protected void updateState(IBlockState state, World worldIn, BlockPos pos, Block blockIn)
    {
        ...
        if (flag1 != flag2)
        {
            ...
            if (flag2)
            {
                worldIn.playSound(null, pos, IRSoundHandler.BLOCK_CATWALKGATE_OPEN, SoundCategory.NEUTRAL, 1.0F, pitch);
            } else
            {
                worldIn.playSound(null, pos, IRSoundHandler.BLOCK_CATWALKGATE_CLOSE, SoundCategory.NEUTRAL, 1.0F, pitch);
            }
        }
    }
