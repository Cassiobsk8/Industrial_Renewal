...
{
    public BlockBigFenceCornerInner(String name, CreativeTabs tab) {
        super(name, tab);
    ...
    @Override
    public boolean ActiveSide(IBlockAccess world, BlockPos pos,  BlockState state, boolean left, boolean top, boolean down)
    {
