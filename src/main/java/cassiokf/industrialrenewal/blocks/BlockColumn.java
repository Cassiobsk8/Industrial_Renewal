...
public class BlockColumn extends BlockBase {
    ...
    protected boolean isValidConnection(final  BlockState neighbourState, final  BlockState ownState, final IBlockAccess world, final BlockPos ownPos, final EnumFacing neighbourDirection) {
    ...
    private boolean canConnectTo(final  BlockState ownState, final IBlockAccess worldIn, final BlockPos ownPos, final EnumFacing neighbourDirection) {
    ...
    private boolean pipeConnected(IBlockAccess world, BlockPos pos,  BlockState state, EnumFacing facing) {
