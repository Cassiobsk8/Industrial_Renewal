...
public class BlockCableTray extends BlockPipeBase<TileEntityFluidPipe> implements ITileEntityProvider
{
    ...
    public boolean canConnectToCapability(IBlockAccess worldIn, BlockPos ownPos, EnumFacing neighbourDirection)
    {
        ...
        return !(state.getBlock() instanceof BlockCableTray) && te != null && te.hasCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, neighbourDirection.getOpposite());
    }
