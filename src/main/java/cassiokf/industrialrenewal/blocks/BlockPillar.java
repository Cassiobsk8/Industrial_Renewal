...
public class BlockPillar extends BlockAbstractSixConnections
{
    public BlockPillar()
    {
    ...
    public static boolean canConnect(IWorld worldIn, BlockPos currentPos, Direction neighborDirection)
    {
        ...
        if (neighborDirection != Direction.UP && neighborDirection != Direction.DOWN)
        {
            return nb instanceof LeverBlock
                    || (nb instanceof BlockHVConnectorBase && neighborState.get(BlockHVConnectorBase.FACING) == neighborDirection.getOpposite())
                    ...
                    || (nb instanceof BlockSignBase && (boolean)neighborState.get(BlockSignBase.ONWALL) && neighborState.get(BlockSignBase.FACING) == neighborDirection.getOpposite())
