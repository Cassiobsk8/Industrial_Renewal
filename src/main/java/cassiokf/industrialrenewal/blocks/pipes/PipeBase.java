...
public class PipeBase extends BlockBase {
    ...
    public PipeBase(final Material material, final String blockName) {
    ...
    protected boolean isValidConnection(final IBlockState ownState, final IBlockState neighbourState, final IBlockAccess world, final BlockPos ownPos, final EnumFacing neighbourDirection) {
        return neighbourState.getBlock() instanceof PipeBase;
    }
    private boolean canConnectTo(final IBlockState ownState, final IBlockAccess worldIn, final BlockPos ownPos, final EnumFacing neighbourDirection) {
        ...
        final boolean thisIsValidForNeighbour = !(neighbourBlock instanceof PipeBase) || ((PipeBase) neighbourBlock).isValidConnection(neighbourState, ownState, worldIn, neighbourPos, neighbourDirection.getOpposite());
