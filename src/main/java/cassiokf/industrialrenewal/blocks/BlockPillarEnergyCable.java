...
public class BlockPillarEnergyCable extends BlockEnergyCable
{
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        if ((playerItem.equals(ItemBlock.getItemFromBlock(ModBlocks.pillar)) || playerItem.equals(ItemBlock.getItemFromBlock(ModBlocks.pillarEnergyCable)))
                && clickedBlock.equals(ModBlocks.pillarEnergyCable))
        {
            int n = 1;
