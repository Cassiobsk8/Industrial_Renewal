...
public class BlockBigFenceWire extends BlockAbstractBigFence
{
    ...
    {
        return world.getBlockState(pos).getBlock() instanceof BlockBigFenceWire;
    }
