...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.BLOCKHAZARD.get(), 16)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.AISLEHAZARD.get(), 16)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CAUTIONHAZARD.get(), 16)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DEFECTIVEHAZARD.get(), 16)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.FIREHAZARD.get(), 16)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.RADIATIONHAZARD.get(), 16)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SAFETYHAZARD.get(), 16)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.STEELBLOCK.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.FRAME.get(), 6)
                .define('A', IRON_ROD)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.SMALL_MOTOR.get(), 2)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BATTERY.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BATTERY_LITHIUM.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.SCREW_DRIVER.get(), 1)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ENERGYCABLE_HV.get(), 6)
                .define('#', Items.GLASS_PANE)
                .define('A', Tags.Items.DUSTS_REDSTONE)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.BARREL.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.PORTABLE_GENERATOR.get(), 1)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_PIPE_LARGE.get(), 16)
                .define('#', STEEL_INGOT)
                .define('A', Tags.Items.NUGGETS_IRON)
                .pattern("A#A")
                .pattern("# #")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_TANK.get(), 1)
                .define('#', STEEL_ROD)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.FIREBOX_SOLID.get(), 1)
                .define('A', Tags.Items.DUSTS_REDSTONE)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.FIREBOX_FLUID.get(), 1)
                .define('A', Tags.Items.DUSTS_REDSTONE)
                .define('B', ModBlocks.FLUID_PIPE.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.INDUSTRIAL_BATTERY_BANK.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.STEAM_BOILER.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.STEAM_TURBINE.get(), 1)
                .define('A', ModBlocks.FLUID_PIPE.get())
                .define('B', ModBlocks.BARREL.get())
                .define('C', Tags.Items.DUSTS_REDSTONE)
                .define('D', ModBlocks.FRAME.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.MINER.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.STORAGE_CHEST.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.TURBINE_PILLAR.get(), 6)
                .define('#', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.WIND_BLADE.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.DRILL_STEEL.get(), 1)
                .define('A', STEEL_ROD)
                .define('B', STEEL_INGOT)
                .pattern(" A ")
                .pattern(" A ")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.DRILL_DIAMOND.get(), 1)
                .define('A', STEEL_ROD)
                .define('B', STEEL_INGOT)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.DRILL_DEEP.get(), 1)
                .define('A', STEEL_INGOT)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.BATTERY_BANK.get(), 1)
                .define('A', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.TRASH.get(), 1)
                .define('A', Tags.Items.INGOTS_IRON)
                .define('B', Items.HOPPER)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ELECTRIC_PUMP.get(), 1)
                .define('A', Tags.Items.INGOTS_IRON)
                .define('B', ModBlocks.FLUID_PIPE.get())
...
//                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.LATHE.get(), 1)
                .define('A', Tags.Items.INGOTS_IRON)
                .define('B', ModItems.SMALL_MOTOR.get())
                .define('C', STEEL_INGOT)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.PILLAR.get(), 16)
                .define('A', Tags.Items.INGOTS_IRON)
                .define('B', IRON_ROD)
                .pattern("BAB")
                .pattern("BAB")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.PILLAR_STEEL.get(), 16)
                .define('A', STEEL_INGOT)
                .define('B', STEEL_ROD)
                .pattern("BAB")
                .pattern("BAB")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.BRACE.get(), 16)
                .define('A', Tags.Items.INGOTS_IRON)
                .define('B', IRON_ROD)
                .pattern("AB ")
                .pattern("BAB")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.BRACE_STEEL.get(), 16)
                .define('A', STEEL_INGOT)
                .define('B', STEEL_ROD)
                .pattern("AB ")
                .pattern("BAB")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.COLUMN.get(), 16)
                .define('A', IRON_ROD)
                .define('B', Tags.Items.INGOTS_IRON)
                .pattern("AAA")
                .pattern("BBB")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.COLUMN_STEEL.get(), 16)
                .define('A', STEEL_ROD)
                .define('B', STEEL_INGOT)
                .pattern("AAA")
                .pattern("BBB")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CATWALK.get(), 6)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CATWALK_STEEL.get(), 6)
                .define('A', Items.IRON_BARS)
                .define('B', STEEL_ROD)
                .pattern("B B")
                .pattern("AAA")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CATWALK_STAIR.get(), 6)
                .define('A', Items.IRON_BARS)
                .define('B', IRON_ROD)
                .pattern("ABB")
                .pattern(" AB")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CATWALK_STAIR_STEEL.get(), 6)
                .define('A', Items.IRON_BARS)
                .define('B', STEEL_ROD)
                .pattern("ABB")
                .pattern(" AB")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.HANDRAIL.get(), 4)
                .define('A', IRON_ROD)
                .pattern("AA")
                .pattern("AA")
                .unlockedBy("has_item", has(IRON_ROD))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.HANDRAIL_STEEL.get(), 4)
                .define('A', STEEL_ROD)
                .pattern("AA")
                .pattern("AA")
                .unlockedBy("has_item", has(STEEL_ROD))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CATWALK_LADDER.get(), 6)
                .define('A', IRON_ROD)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CATWALK_LADDER_STEEL.get(), 6)
                .define('A', STEEL_ROD)
                .define('B', Items.LADDER)
                .pattern("A A")
                .pattern("ABA")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.PLATFORM.get(), 4)
                .define('A', IRON_ROD)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.SCAFFOLD.get(), 12)
                .define('A', IRON_ROD)
                .define('B', ItemTags.PLANKS)
                .pattern("ABA")
                .pattern("A A")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CATWALK_GATE.get(), 2)
                .define('A', IRON_ROD)
                .define('B', Tags.Items.INGOTS_IRON)
                .pattern("ABA")
                .pattern("ABA")
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModBlocks.CATWALK_HATCH.get(), 1)
...
//                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ELECTRIC_FENCE.get(), 6)
                .define('A', IRON_ROD)
                .define('B', STEEL_ROD)
                .pattern("ABA")
                .pattern("ABA")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ELECTRIC_GATE.get(), 4)
                .define('A', STEEL_ROD)
                .define('B', Tags.Items.INGOTS_IRON)
                .pattern("ABA")
                .pattern("ABA")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.RAZOR_WIRE.get(), 6)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModBlocks.LIGHT.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUORESCENT.get(), 4)
                .define('A', IRON_ROD)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.DAM_INTAKE.get(), 1)
                .define('A', ModBlocks.CONCRETE.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.DAM_OUTLET.get(), 1)
                .define('A', ModBlocks.CONCRETE.get())
                .define('B', Items.IRON_BARS)
                .pattern("AAA")
                .pattern("B B")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.HIGH_PRESSURE_PIPE.get(), 2)
                .define('A', STEEL_INGOT)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.DAM_TURBINE.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.DAM_GENERATOR.get(), 1)
                .define('A', STEEL_INGOT)
                .define('C', STEEL_ROD)
                .define('B', ModItems.SMALL_MOTOR.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ROTATIONAL_SHAFT.get(), 9)
                .define('A', STEEL_BLOCKS)
                .pattern("A")
                .pattern("A")
                .pattern("A")
...
//                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CONVEYOR_BASIC.get(), 8)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CONVEYOR_FAST.get(), 8)
                .define('A', Tags.Items.LEATHER)
                .define('B', STEEL_ROD)
                .define('C', ModItems.SMALL_MOTOR.get())
                .define('D', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.CONVEYOR_EXPRESS.get(), 8)
                .define('A', Tags.Items.LEATHER)
                .define('C', ModItems.SMALL_MOTOR.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.INDUSTRIAL_FLOOR.get(), 6)
                .define('A', Items.IRON_BARS)
                .define('B', Tags.Items.INGOTS_IRON)
                .pattern("AAA")
                .pattern("   ")
...
//                .save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.SPANEL_FRAME.get(), 1)
                .define('A', IRON_ROD)
                .define('B', ModItems.BATTERY.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.HV_ISOLATOR.get(), 1)
                .define('A', GOLD_ROD)
                .define('B', STEEL_INGOT)
                .pattern("A")
                .pattern("B")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.TRANSFORMER.get(), 1)
                .define('A', STEEL_INGOT)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FLUID_VALVE.get(), 1)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ENERGY_SWITCH.get(), 1)
                .define('A', Items.LEVER)
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeSerializer<? extends AbstractCookingRecipe> pCookingSerializer, List<ItemLike> pIngredients, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, String pGroup, String pRecipeName) {
        for(ItemLike itemlike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(new ItemLike[]{itemlike}), pCategory, pResult, pExperience, pCookingTime, pCookingSerializer)
                    ...
                    .save(pFinishedRecipeConsumer, IndustrialRenewal.MODID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
        }
