...
public class BlockElectricFence extends BlockBasicElectricFence {
    ...
    public boolean canConnectTo(Level worldIn, BlockPos currentPos, Direction neighborDirection) {
        ...
        return nb instanceof BlockElectricFence || nb instanceof BlockElectricGate || neighborState.isFaceSturdy(worldIn, currentPos.relative(neighborDirection), neighborDirection) || nb instanceof BlockBasicElectricFence || nb instanceof BlockPillar || nb instanceof BlockColumn
