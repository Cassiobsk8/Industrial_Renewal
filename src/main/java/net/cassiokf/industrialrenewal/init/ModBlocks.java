...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, IndustrialRenewal.MODID);
    ...
    public static final RegistryObject<BlockSolarPanelFrame> SPANEL_FRAME = registerBlock("solar_panel_frame", () -> new BlockSolarPanelFrame(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    public static final RegistryObject<Block> BATTERY_BANK = registerBlock("battery_bank", BlockBatteryBank::new);
    
    
    public static final RegistryObject<BlockEnergyCable> ENERGYCABLE_LV = registerBlock("energy_cable_lv", () -> new BlockEnergyCable(EnumEnergyCableType.LV));
    
    public static final RegistryObject<BlockEnergyCable> ENERGYCABLE_MV = registerBlock("energy_cable_mv", () -> new BlockEnergyCable(EnumEnergyCableType.MV));
    
    public static final RegistryObject<BlockEnergyCable> ENERGYCABLE_HV = registerBlock("energy_cable_hv", () -> new BlockEnergyCable(EnumEnergyCableType.HV));
    
    public static final RegistryObject<BlockEnergyCableMeter> ENERGYCABLE_LV_METER = registerBlock("energy_cable_gauge_lv", () -> new BlockEnergyCableMeter(EnumEnergyCableType.LV), false);
    
    public static final RegistryObject<BlockEnergyCableMeter> ENERGYCABLE_MV_METER = registerBlock("energy_cable_gauge_mv", () -> new BlockEnergyCableMeter(EnumEnergyCableType.MV), false);
    
    public static final RegistryObject<BlockEnergyCableMeter> ENERGYCABLE_HV_METER = registerBlock("energy_cable_gauge_hv", () -> new BlockEnergyCableMeter(EnumEnergyCableType.HV), false);
    ...
    public static final RegistryObject<BlockEnergySwitch> ENERGY_SWITCH = registerBlock("energy_switch", () -> new BlockEnergySwitch(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(0.8f).noOcclusion()));
    public static final RegistryObject<BlockFluidValve> FLUID_VALVE = registerBlock("valve_pipe_large", () -> new BlockFluidValve(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(0.8f).noOcclusion()));
    
    public static final RegistryObject<BlockElectricPump> ELECTRIC_PUMP = registerBlock("electric_pump", () -> new BlockElectricPump(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f)));
    
    public static final RegistryObject<BlockTrash> TRASH = registerBlock("trash", () -> new BlockTrash(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    public static final RegistryObject<BlockWindTurbinePillar> TURBINE_PILLAR = registerBlock("small_wind_turbine_pillar", () -> new BlockWindTurbinePillar(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(0.8f).noOcclusion()));
    
    public static final RegistryObject<BlockWindTurbineHead> WIND_TURBINE = registerBlock("small_wind_turbine", () -> new BlockWindTurbineHead(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(0.8f).noOcclusion()));
    
    public static final RegistryObject<BlockPortableGenerator> PORTABLE_GENERATOR = registerBlock("portable_generator", () -> new BlockPortableGenerator(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    
    public static final RegistryObject<BlockConveyor> CONVEYOR_BASIC = registerBlock("conveyor_bulk_basic", () -> new BlockConveyor(EnumConveyorTier.BASIC));
    
    public static final RegistryObject<BlockConveyor> CONVEYOR_FAST = registerBlock("conveyor_bulk_fast", () -> new BlockConveyor(EnumConveyorTier.FAST));
    
    public static final RegistryObject<BlockConveyor> CONVEYOR_EXPRESS = registerBlock("conveyor_bulk_express", () -> new BlockConveyor(EnumConveyorTier.EXPRESS));
    
    
    public static final RegistryObject<BlockSteamBoiler> STEAM_BOILER = registerBlock("steam_boiler", () -> new BlockSteamBoiler(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    public static final RegistryObject<BlockSteamTurbine> STEAM_TURBINE = registerBlock("steam_turbine", () -> new BlockSteamTurbine(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    
    public static final RegistryObject<BlockMiner> MINER = registerBlock("mining", () -> new BlockMiner(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    public static final RegistryObject<BlockIndustrialBatteryBank> INDUSTRIAL_BATTERY_BANK = registerBlock("ind_battery_bank", () -> new BlockIndustrialBatteryBank(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    
    public static final RegistryObject<BlockFluidTank> FLUID_TANK = registerBlock("fluid_tank", () -> new BlockFluidTank(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    
    public static final RegistryObject<BlockStorageChest> STORAGE_CHEST = registerBlock("storage_chest", () -> new BlockStorageChest(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(0.8f).noOcclusion()));
    
    
    public static final RegistryObject<BlockLathe> LATHE = registerBlock("lathe", () -> new BlockLathe(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    ...
    public static final RegistryObject<BlockDamTurbine> DAM_TURBINE = registerBlock("dam_turbine", () -> new BlockDamTurbine(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    public static final RegistryObject<BlockRotationalShaft> ROTATIONAL_SHAFT = registerBlock("dam_axis", BlockRotationalShaft::new);
    
    public static final RegistryObject<BlockDamGenerator> DAM_GENERATOR = registerBlock("dam_generator", () -> new BlockDamGenerator(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    
    public static final RegistryObject<BlockTransformer> TRANSFORMER = registerBlock("transformer_hv", () -> new BlockTransformer(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(1f).noOcclusion()));
    
    public static final RegistryObject<BlockHVIsolator> HV_ISOLATOR = registerBlock("isolator_hv", () -> new BlockHVIsolator(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(0.8f).noOcclusion()));
    
    public static final RegistryObject<BlockInfinityGenerator> INFINITY_GENERATOR = registerBlock("infinity_generator", BlockInfinityGenerator::new);
    
    public static final RegistryObject<BlockEnergyLevel> ENERGY_LEVEL = registerBlock("energy_level", BlockEnergyLevel::new);
    
    public static final RegistryObject<BlockFluidGauge> FLUID_GAUGE = registerBlock("fluid_gauge", BlockFluidGauge::new);
    ...
    private static <T extends Block> RegistryObject<T> registerBlock(String name, Supplier<T> block, boolean createItem) {
        ...
        if (createItem) registryBlockItem(name, toReturn);
        return toReturn;
    }
