...
public class ModItems {
    ...
    public static final RegistryObject<Item> WIND_BLADE = registerItem("small_wind_blade", () -> new ItemWindBlade(new Item.Properties().durability(48 * 60)));
    
    public static final RegistryObject<Item> FIREBOX_SOLID = registerItem("firebox_solid", () -> new ItemFireBox(new Item.Properties(), 1));
    
    public static final RegistryObject<Item> FIREBOX_FLUID = registerItem("firebox_fluid", () -> new ItemFireBox(new Item.Properties(), 2));
    
    public static final RegistryObject<Item> DRILL_STEEL = registerItem("drill_steel", () -> new ItemDrill(new Item.Properties().durability(600)));
    
    public static final RegistryObject<Item> DRILL_DIAMOND = registerItem("drill_diamond", () -> new ItemDrill(new Item.Properties().durability(1200)));
    
    public static final RegistryObject<Item> DRILL_DEEP = registerItem("drill_deep", () -> new ItemDrill(new Item.Properties().durability(2000)));
    
    public static final RegistryObject<Item> BATTERY = registerItem("battery", () -> new ItemBattery(new Item.Properties().stacksTo(1), 10000, 1000));
    
    public static final RegistryObject<Item> BATTERY_LITHIUM = registerItem("battery_lithium", () -> new ItemBattery(new Item.Properties().stacksTo(1), 100000, 10000));
    
    public static final RegistryObject<Item> WIRE_COIL = registerItem("coil_hv", () -> new ItemWireCoil(new Item.Properties()));
    
    public static final RegistryObject<BlockItem> PILLAR = registerItem("catwalk_pillar", () -> new ItemBlockPillar(ModBlocks.PILLAR.get(), new Item.Properties()));
    
    public static final RegistryObject<BlockItem> PILLAR_STEEL = registerItem("catwalk_steel_pillar", () -> new ItemBlockPillar(ModBlocks.PILLAR_STEEL.get(), new Item.Properties()));
    
    public static final RegistryObject<BlockItem> CATWALK = registerItem("catwalk", () -> new ItemBlockCatwalk(ModBlocks.CATWALK.get(), new Item.Properties()));
    
    public static final RegistryObject<BlockItem> CATWALK_STEEL = registerItem("catwalk_steel", () -> new ItemBlockCatwalk(ModBlocks.CATWALK_STEEL.get(), new Item.Properties()));
    
    public static final RegistryObject<BlockItem> CATWALK_STAIR = registerItem("catwalk_stair", () -> new ItemBlockCatwalkStair(ModBlocks.CATWALK_STAIR.get(), new Item.Properties()));
    
    public static final RegistryObject<BlockItem> CATWALK_STEEL_STAIR = registerItem("catwalk_stair_steel", () -> new ItemBlockCatwalkStair(ModBlocks.CATWALK_STAIR_STEEL.get(), new Item.Properties()));
    
    public static final RegistryObject<BlockItem> CATWALK_LADDER = registerItem("catwalk_ladder", () -> new ItemBlockCatwalkLadder(ModBlocks.CATWALK_LADDER.get(), new Item.Properties()));
    
    public static final RegistryObject<BlockItem> CATWALK_LADDER_STEEL = registerItem("catwalk_ladder_steel", () -> new ItemBlockCatwalkLadder(ModBlocks.CATWALK_LADDER_STEEL.get(), new Item.Properties()));
    
    public static final RegistryObject<BlockItem> PLATFORM = registerItem("platform", () -> new ItemBlockPlatform(ModBlocks.PLATFORM.get(), new Item.Properties()));
    
    public static final RegistryObject<BlockItem> SCAFFOLD = registerItem("scaffold", () -> new ItemBlockScaffold(ModBlocks.SCAFFOLD.get(), new Item.Properties()));
