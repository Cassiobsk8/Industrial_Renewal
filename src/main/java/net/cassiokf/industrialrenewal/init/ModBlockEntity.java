...
public class ModBlockEntity {
    ...
    public static RegistryObject<BlockEntityType<BEFluidPipeGauge>> FLUIDPIPE_GAUGE_TILE =
            BLOCK_ENTITIES.register("fluidpipe_gauge_tile", ()-> BlockEntityType.Builder.of(
                    BEFluidPipeGauge::new, ModBlocks.FLUID_PIPE_GAUGE.get()).build(null));
...
//                    BlockEntityFluidLoader::new, ModBlocks.FLUID_LOADER.get()).build(null));
    ...
    public static RegistryObject<BlockEntityType<BlockEntityInfinityGenerator>> INFINITY_GENERATOR =
            BLOCK_ENTITIES.register("infinity_generator", ()-> BlockEntityType.Builder.of(
                    BlockEntityInfinityGenerator::new, ModBlocks.INFINITY_GENERATOR.get()).build(null));
    
    public static RegistryObject<BlockEntityType<BlockEntityEnergyLevel>> ENERGY_LEVEL =
            BLOCK_ENTITIES.register("energy_level", ()-> BlockEntityType.Builder.of(
                    BlockEntityEnergyLevel::new, ModBlocks.ENERGY_LEVEL.get()).build(null));
    
    public static RegistryObject<BlockEntityType<BlockEntityFluidGauge>> FLUID_GAUGE =
            BLOCK_ENTITIES.register("fluid_gauge", ()-> BlockEntityType.Builder.of(
                    BlockEntityFluidGauge::new, ModBlocks.FLUID_GAUGE.get()).build(null));
